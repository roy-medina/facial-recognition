...
root = os.getcwd()
os.chdir(os.path.join(os.getcwd(), 'memory'))

# Load a sample picture and learn how to recognize it.
roy_image = face_recognition.load_image_file("roy.jpg")
...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            face_distances = face_recognition.face_distance(known_face_encodings, face_encoding)        # on face_recognition/api line 75 , added parameter (dtype=object)
            best_match_index = np.argmin(face_distances, dtype=object)
